...
const MOCK_BATCHES = {
  'BATCH-A4F2': {
    ...
    events: [
      { step: 'Harvest', icon: 'farm', date: '2026-01-10', location: 'Musanze Farm — Plot 14B', detail: 'Harvested by Alain Nkurunziza, 450 kg Grade A', status: 'done' },
      { step: 'Storage', icon: 'store', date: '2026-01-10', location: 'Cooperative Cold Store A', detail: 'Stored at 12°C, humidity 68% — quality check passed', status: 'done' },
      { step: 'Dispatch', icon: 'truck', date: '2026-01-13', location: 'Musanze → Kigali', detail: 'Transporter: Jean Mugisha · Vehicle RAD 342C', status: 'done' },
      { step: 'In Transit', icon: 'truck', date: '2026-01-13', location: 'Kigali outskirts', detail: 'Cold chain maintained · Temp 11.2°C', status: 'active' },
  ...
  'BATCH-B7D1': {
    ...
    events: [
      { step: 'Harvest', icon: 'farm', date: '2026-01-09', location: 'Huye Farm — Block 3', detail: 'Harvested by Solange Mukamana, 300 kg Grade A', status: 'done' },
      { step: 'Storage', icon: 'store', date: '2026-01-09', location: 'Cooperative Dry Store', detail: 'Quality check passed — Grade A confirmed', status: 'done' },
      { step: 'Dispatch', icon: 'truck', date: '2026-01-13', location: 'Huye → Kigali', detail: 'Transporter: Marie Uwase · Vehicle RAC 108A', status: 'active' },
